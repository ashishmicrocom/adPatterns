...
// Minimal local Vec2 implementation to avoid an external vecteur dependency
...
export const MagneticCursor: FC<MagneticCursorProps> = ({
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      const { speedMultiplier, maxScaleX, maxScaleY } = configRef.current;
