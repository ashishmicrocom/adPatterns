...
export const AnimatedThemeToggle = ({ className }: { className?: string }) => {
  ...
  return (
    <Button
      onClick={toggleTheme}
      // make this icon-only: remove padding, background, border and hover background
      className={cn("p-0 bg-transparent border-none hover:bg-transparent text-inherit", className)}
      variant="ghost"
      size="icon"
